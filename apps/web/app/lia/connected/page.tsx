...
// The Google OAuth callback redirects here (returnTo) so the host lands on a
  ...
  return (
    <div
      ...
      <div
        ...
        <h1 style={{ margin: "0 0 10px", fontSize: 22, color: "#004643" }}>
          Your calendar is connected
        </h1>
        <p style={{ margin: 0, fontSize: 15, lineHeight: 1.55, color: "#45555c" }}>
          You&rsquo;re all set — you can close this tab. Booked discovery calls will now land
          directly on your calendar, and your availability is kept in sync automatically.
        </p>
      </div>
    </div>
  );
