...
import { getSlugOrRequestedSlug, orgDomainConfig, getOrganizationSEOSettings } from "@lib/team/nonOrgTeamHelpers";
...
export const getServerSideProps = async (context: GetServerSidePropsContext) => {
  ...
  const [eventHostsUserData, crmResult, teamHasApiV2Route, booking] = await Promise.all([
    ...
    // CRM contact-owner lookup is an enterprise feature, unavailable here.
    Promise.resolve(
      null as {
        email?: string;
        recordType?: string;
